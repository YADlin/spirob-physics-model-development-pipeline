...
Validation: 198 passed, 1 existing xfailed. Full 2/3/4-cable builds compile in
MuJoCo. Two-cable CSV, 21 simulation STL meshes and MJCF are byte-identical to
main using the same dependencies. Six-copy two-cable array compiles with 127
...
See docs/CONSOLIDATION_REPAIR.md and its actual exported-mesh comparison.
